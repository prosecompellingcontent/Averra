...
export function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fdf5f7] text-[#251218] relative pb-32 md:pb-0">
      {/* Content */}
      <div className="relative z-10">
        ...
        <section className="relative min-h-screen w-full overflow-hidden">
          <div className="relative z-10 min-h-full flex items-center justify-center px-8 py-24">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-16">
                <h1
                  className="text-[clamp(3.5rem,10vw,6rem)] text-[#251218] mb-8 leading-[0.9]"
              ...
              <div className="grid md:grid-cols-5 gap-8 md:gap-12 mb-16">
                ...
                <div className="md:col-span-2 space-y-8">
                  ...
                  <div className="glass-effect border border-white/30 p-8">
                    <h3 
                      className="text-xs uppercase tracking-[0.2em] text-[#251218]/60 mb-4" 
                    ...
                    <p 
                      className="text-sm text-[#251218]/70 leading-relaxed" 
                  ...
                  <div className="glass-effect border border-white/30 p-8">
                    ...
                    <div className="pt-6 border-t border-[#251218]/10">
                      <p 
                        className="text-sm text-[#251218]/70 leading-relaxed mb-3" 
                  ...
                  <div className="glass-effect border border-white/30 p-8">
                    ...
                    <div className="text-base text-[#251218]/80 leading-relaxed space-y-4" style={{ fontFamily: 'Lora, serif' }}>
                      <p className="text-sm">
                ...
                <div className="md:col-span-3">
                  <div className="glass-effect border border-white/30 p-10 md:p-12">
                    <h2 
                      className="text-3xl md:text-4xl text-[#251218] mb-3 text-center" 
                      style={{ fontFamily: 'Playfair Display, serif', fontWeight: 400 }}
                    >
                      Send an Inquiry
                    </h2>
                    <p 
                      className="text-center text-sm text-[#251218]/60 mb-10 uppercase tracking-wider" 
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                        <label 
                          htmlFor="name" 
                          className="block text-xs uppercase tracking-[0.15em] text-[#251218]/70 mb-3" 
                          style={{ fontFamily: 'Inter, sans-serif', fontWeight: 600 }}
                        >
                          Full Name *
                        </label>
                        <input
                          ...
                          required
                          className="w-full px-5 py-4 bg-white/40 border border-[#251218]/20 text-[#251218] placeholder-[#251218]/40 focus:outline-none focus:border-[#c9969e] focus:ring-2 focus:ring-[#c9969e]/20 transition-all duration-200"
                      ...
                      <div>
                        <label 
                          ...
                          style={{ fontFamily: 'Inter, sans-serif', fontWeight: 600 }}
                        >
                          Phone Number <span className="text-[#251218]/40">(Optional)</span>
                        </label>
                        <input
                          type="tel"
                          id="phone"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          required
                          rows={6}
                          className="w-full px-5 py-4 bg-white/40 border border-[#251218]/20 text-[#251218] placeholder-[#251218]/40 focus:outline-none focus:border-[#c9969e] focus:ring-2 focus:ring-[#c9969e]/20 resize-none transition-all duration-200"
                      ...
                      <div className="pt-4">
                        <button
                          ...
                          className="w-full px-8 py-5 bg-[#251218] text-[#fdf5f7] uppercase tracking-[0.2em] hover:bg-[#c9969e] transition-all duration-300 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                      ...
                      {submitStatus === "success" && (
                        <div className="text-center p-5 bg-[#c9969e]/10 border border-[#c9969e]/30 text-[#251218]" style={{ fontFamily: 'Lora, serif' }}>
                          <p className="font-semibold mb-1">Message sent successfully.</p>
                          <p className="text-sm text-[#251218]/70">We'll respond within 1–2 business days.</p>
                        </div>
                      )}
                      {submitStatus === "error" && (
              ...
              <div className="text-center max-w-3xl mx-auto">
                <div className="inline-block glass-effect border border-white/30 px-8 py-6">
                  ...
                  >
                    ...
                    <a 
                      href="/quiz" 
                      className="text-[#c9969e] hover:text-[#251218] underline underline-offset-2 font-semibold transition-colors duration-200"
                    >
                      Take the Brand Quiz
                    </a>
