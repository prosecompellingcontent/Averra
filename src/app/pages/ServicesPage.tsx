      ...
      <div className="min-h-screen bg-[#DCDACC] text-[#221412]">
        ...
        <section
          className={`relative w-full overflow-hidden ${
            isMobile ? "min-h-[600px] mb-0" : "min-h-svh"
          }`}
        >
          ...
          <div className="relative py-16 text-center">
            ...
            <div className="mb-8 border-y border-[#C9A961]/30 py-4 hidden md:block">
              <MarqueeScroll disableOnMobile={false} duration={30}>
                <div className="flex items-center gap-8 text-[#DCDACC] text-sm uppercase tracking-[0.3em] font-light whitespace-nowrap">
                  <span>LAUNCH PRICING · April 1st–August 31st</span>
                  <span>•</span>
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-8">
              ...
              <div className="inline-block px-8 py-2 bg-[#DCDACC] mb-6">
                <span className="text-sm md:text-base text-[#221412] font-medium uppercase tracking-[0.2em]">
                  Limited Time Only
                </span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="space-y-12 mb-32">
            {tiers.map((tier, tierIndex) => (
              <div
                ...
                className={`${
                  tier.featured
                    ? "bg-white border-2 border-[#221412]"
                    : "bg-white/60"
                } p-12`}
                style={{
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                  <div className="lg:col-span-1 space-y-8">
                    ...
                    <div>
                      <h2
                        className="text-3xl text-[#221412] mb-2"
                        style={{
                          fontFamily: "Cormorant, serif",
                          fontWeight: 300,
                        }}
                      ...
                      <p
                        className="text-base text-[#221412]/70 font-light italic mb-6 whitespace-pre-line"
                      ...
                      <div className="mb-3">
                        <span
                          className="text-2xl text-[#221412]/40 line-through mr-3"
                          style={{
                            fontFamily: "Cormorant, serif",
                            fontWeight: 300,
                          }}
                        ...
                        <span
                          className="text-4xl text-[#221412]"
                          style={{
                            fontFamily: "Cormorant, serif",
                            fontWeight: 300,
                          }}
                    ...
                    <button
                      ...
                      className={`inline-block w-full py-4 bg-[#221412] text-white text-center text-sm uppercase tracking-[0.3em] font-light ${
                        !isMobile ? "hover:bg-[#3d2b26]" : ""
                    ...
                    <div className="grid grid-cols-1 gap-y-1">
                      {tier.features.map((feature, index) => (
                        <div key={index} className="flex gap-4 mb-3">
                          <Check
                            className="w-5 h-5 text-[#221412] flex-shrink-0 mt-0.5"
                            strokeWidth={1.5}
                          />
                          <div>
          ...
          <div className="mb-32">
            <div className="text-center mb-16">
              ...
              <h2
                className="text-[clamp(2.5rem,8vw,4rem)] text-[#221412] mb-6"
                style={{ fontFamily: "Cormorant, serif", fontWeight: 300 }}
              >
                Brand-Ready Visuals
              </h2>
              ...
              >
                ...
                <p
                  className="text-xs text-[#221412]/70 font-light leading-relaxed italic"
                  style={{ fontFamily: "Cormorant, serif" }}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {digitalProducts.map((product) => (
                ...
                >
                  <h3
                    className="text-xl text-[#221412] mb-3"
                    style={{
                      fontFamily: "Cormorant, serif",
                      fontWeight: 300,
                    }}
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <span
                      className="text-lg text-[#221412]/40 line-through"
                      style={{
                        fontFamily: "Cormorant, serif",
                        fontWeight: 300,
                      }}
                    ...
                    <span
                      className="text-3xl text-[#221412]"
                      style={{
                        fontFamily: "Cormorant, serif",
                        fontWeight: 300,
                      }}
                  ...
                  <div className="mb-4 space-y-2">
                    <p className="text-[10px] uppercase tracking-[0.3em] text-[#221412]/60 mb-3">
                      Inside This Pack:
                    </p>
                    {product.scenes?.map((scene, idx) => (
                      <div key={idx} className="mb-3">
                        <p className="text-xs text-[#221412] font-medium mb-1">
                          {scene.title}
                        </p>
                        <p className="text-xs text-[#221412]/70 font-light leading-relaxed">
                          {scene.detail}
                        </p>
                      </div>
                    ))}
                  ...
                  <div className="mb-4 space-y-1">
                    {product.includes?.map((item, idx) => (
                      <p key={idx} className="text-xs text-[#221412]/70 font-light">
                        • {item}
                      </p>
                    ))}
                  </div>
                  ...
                  <p
                    className="text-xs text-[#221412]/70 italic mb-6 leading-relaxed"
                    style={{ fontFamily: "Cormorant, serif" }}
                  >
                    {product.positioning}
                  </p>
                ...
                <div className="bg-[#221412] px-20 py-10 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-center gap-3 mb-3">
                      ...
                      <span
                        className="text-[9px] uppercase tracking-[0.5em] text-[#DCDACC]/60"
                        style={{
                    ...
                    <p
                      className="text-4xl text-[#DCDACC]"
                      style={{
                        fontFamily: "Cormorant, serif",
                        fontWeight: 300,
                        fontStyle: "italic",
