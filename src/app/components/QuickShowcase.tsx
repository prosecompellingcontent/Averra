...
// FIX: allImages must be valid strings (URLs). Keep same behavior/visuals.
const allImages = [
  assetUrl("carousel-1.webp"),
  assetUrl("carousel-2.webp"),
  assetUrl("carousel-3.webp"),
  assetUrl("carousel-4.webp"),
  assetUrl("carousel-5.webp"),
  assetUrl("carousel-6.webp"),
  assetUrl("carousel-7.webp"),
  assetUrl("carousel-8.webp"),
];
